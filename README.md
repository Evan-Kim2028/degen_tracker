...
### Running the code
run `partial_sync_stream_db.py` to get started streaming queried logs data into a database. Then run `stream_metrics.py` to stream a counting metric in real time.
